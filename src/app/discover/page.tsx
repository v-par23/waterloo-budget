  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-gray-50 rounded-xl sm:rounded-2xl">
        ...
        <ul className="list-disc pl-5 space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-600">
          <li><strong>PAC/CIF gym</strong> is included in your student fees - no extra cost!</li>
          <li><strong>DC Library</strong> is open 24/7 during exam season with free printing credits</li>
          <li><strong>Velocity</strong> and <strong>GreenHouse</strong> offer free co-working for UW students</li>
          <li>Most Plaza restaurants have student discounts - just ask!</li>
        </ul>
      </div>
    </div>
  );
