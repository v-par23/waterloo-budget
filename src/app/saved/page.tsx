...
export default function SavedPage() {
    ...
    return (
      <div className="space-y-6">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-gray-900">❤️ My Saved Spots</h1>
        </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
          <p className="text-gray-600 mb-4">Sign in to save your favorite spots</p>
          <Link
            href="/login"
  ...
  return (
    <div className="space-y-6">
      ...
      {savedSpots.length === 0 ? (
        <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
          <p className="text-gray-600 mb-4">You haven&apos;t saved any spots yet</p>
